...
public class parametresInputInference {
  ...
  public parametresInputInference(
      Boolean equivalentClass,
      Boolean sameIndividual,
      Boolean differentIndividual,
      Boolean IntersectionOf,
      Boolean UnionOf,
      Boolean DisjointClasses,
      Boolean HasValue,
      Boolean InverseObjectProperties,
      Boolean AllValuesFrom,
      Boolean SomeValuesFrom,
      Boolean DomainAndRange) {
