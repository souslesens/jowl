...
public class SWRLServiceImpl implements SWRLService {
  ...
  @Override
  public String SWRLruleReclassification(
      String filePath, String url, String[] reqBodies, String[] reqHead) throws Exception {
    try {
      ...
      SWRLVariable var =
          factory.getSWRLVariable(
              IRI.create(ontology.getOntologyID().getOntologyIRI().get() + "#x"));
      ...
      for (OWLClass cls : classes) {
        NodeSet<OWLNamedIndividual> inferredIndv =
            reasoner.getInstances(cls, false); // false = only inferred
        for (Node<OWLNamedIndividual> individualNode : inferredIndv) {
          for (OWLNamedIndividual individual : individualNode) {
            ...
            instances
                .computeIfAbsent(individual.getIRI().toString(), k -> new HashSet<>())
                .add(cls.getIRI().toString());
          }
        }
      }
      Gson gson = new Gson();
  ...
  @Override
  public String SWRLruleReclassificationB64(
        ...
        if (swrlVariable1.getType().equalsIgnoreCase("owl:Class")) {
          for (SWRLVariables entity : swrlVariable1.getEntities()) {
            ...
            for (String table : variables) {
              SWRLVariable swrlVar =
                  factory.getSWRLVariable(
                      IRI.create(ontology.getOntologyID().getOntologyIRI().get() + "#" + table));
          ...
          for (SWRLVariables entity : swrlVariable1.getEntities()) {
            OWLObjectProperty ObjectPropertyX =
                factory.getOWLObjectProperty(IRI.create(entity.getName()));
            String[] variables = entity.getVar();
            ...
            for (int v = 0; v < variables.length; v += 2) {
              ...
              SWRLVariable swrlVar1 =
                  factory.getSWRLVariable(
                      IRI.create(
                          ontology.getOntologyID().getOntologyIRI().get() + "#" + variable1));
              SWRLVariable swrlVar2 =
                  factory.getSWRLVariable(
                      IRI.create(
                          ontology.getOntologyID().getOntologyIRI().get() + "#" + variable2));
              SWRLObjectPropertyAtom bodyElement =
                  factory.getSWRLObjectPropertyAtom(ObjectPropertyX, swrlVar1, swrlVar2);
              bodyList.add(bodyElement);
            }
          }
        } else if (swrlVariable1.getType().equalsIgnoreCase("owl:DataProperty")) {
          for (SWRLVariables entity : swrlVariable1.getEntities()) {
            OWLDataProperty dataPropertyVar =
                factory.getOWLDataProperty(IRI.create(entity.getName()));
            String[] variables = entity.getVar();
            if (variables.length != 2) {
            ...
            for (int v = 0; v < variables.length; v += 2) {
              ...
              SWRLVariable swrlVar2 =
                  factory.getSWRLVariable(
                      IRI.create(
                          ontology.getOntologyID().getOntologyIRI().get() + "#" + variable2));
              SWRLDataPropertyAtom bodyElement =
                  factory.getSWRLDataPropertyAtom(dataPropertyVar, swrlVar1, swrlVar2);
            ...
            for (String table : variables) {
              ...
              for (String Lit : literal) {
                ...
                if (entity.getName().equalsIgnoreCase("greaterThanOrEqual")) {
                  bodyElement =
                      factory.getSWRLBuiltInAtom(
                          SWRLBuiltInsVocabulary.GREATER_THAN_OR_EQUAL.getIRI(), arguments);
                } else if (entity.getName().equalsIgnoreCase("lessThanOrEqual")) {
                  bodyElement =
                      factory.getSWRLBuiltInAtom(
                          SWRLBuiltInsVocabulary.LESS_THAN_OR_EQUAL.getIRI(), arguments);
                } else if (entity.getName().equalsIgnoreCase("greaterThan")) {
                  bodyElement =
                      factory.getSWRLBuiltInAtom(
                          SWRLBuiltInsVocabulary.GREATER_THAN.getIRI(), arguments);
                } else if (entity.getName().equalsIgnoreCase("lessThan")) {
                  bodyElement =
                      factory.getSWRLBuiltInAtom(
                          SWRLBuiltInsVocabulary.LESS_THAN.getIRI(), arguments);
                  ...
                  bodyElement =
                      factory.getSWRLBuiltInAtom(
                          SWRLBuiltInsVocabulary.NOT_EQUAL.getIRI(), arguments);
                }
                System.out.println(bodyElement);
                bodyList.add(bodyElement);
              }
          ...
          for (SWRLVariables entity : swrlVariable1.getEntities()) {
            ...
            //	   	    	        if (literal.length != 1) {
            //	   	    	            throw new IllegalArgumentException("The variable list must
            // contains 2 arguemts");
            //	   	    	        }
            ...
            for (String table : variables) {
              ...
              if (literal.length == 1) {
                for (String Lit : literal) {
                  ...
                  List<SWRLDArgument> arguments =
                      new ArrayList<>(Arrays.asList(swrlVar, LitVarArg));
                  if (entity.getName().equalsIgnoreCase("contains")) {
                    bodyElement =
                        factory.getSWRLBuiltInAtom(
                            SWRLBuiltInsVocabulary.CONTAINS.getIRI(), arguments);
                  } else if (entity.getName().equalsIgnoreCase("containsIgnoreCase")) {
                    bodyElement =
                        factory.getSWRLBuiltInAtom(
                            SWRLBuiltInsVocabulary.CONTAINS_IGNORE_CASE.getIRI(), arguments);
                  } else if (entity.getName().equalsIgnoreCase("startsWith")) {
                    bodyElement =
                        factory.getSWRLBuiltInAtom(
                            SWRLBuiltInsVocabulary.STARTS_WITH.getIRI(), arguments);
                  } else if (entity.getName().equalsIgnoreCase("endsWith")) {
                    bodyElement =
                        factory.getSWRLBuiltInAtom(
                            SWRLBuiltInsVocabulary.ENDS_WITH.getIRI(), arguments);
                  } else if (entity.getName().equalsIgnoreCase("matches")) {
                    bodyElement =
                        factory.getSWRLBuiltInAtom(
                            (IRI.create("http://www.w3.org/2003/11/swrlb#matches")), arguments);
                  } else if (entity.getName().equalsIgnoreCase("stringEqualIgnoreCase")) {
                    bodyElement =
                        factory.getSWRLBuiltInAtom(
                            (SWRLBuiltInsVocabulary.STRING_EQUALS_IGNORE_CASE.getIRI()), arguments);
                  } else if (entity.getName().equalsIgnoreCase("upperCase")) {
                    bodyElement =
                        factory.getSWRLBuiltInAtom(
                            (IRI.create("http://www.w3.org/2003/11/swrlb#upperCase")), arguments);
                  } else if (entity.getName().equalsIgnoreCase("lowerCase")) {
                    bodyElement =
                        factory.getSWRLBuiltInAtom(
                            (SWRLBuiltInsVocabulary.LOWER_CASE.getIRI()), arguments);
                  } else if (entity.getName().equalsIgnoreCase("stringLength")) {
                    bodyElement =
                        factory.getSWRLBuiltInAtom(
                            (SWRLBuiltInsVocabulary.STRING_LENGTH.getIRI()), arguments);
                  } else if (entity.getName().equalsIgnoreCase("normalizeSpace")) {
                    bodyElement =
                        factory.getSWRLBuiltInAtom(
                            (SWRLBuiltInsVocabulary.NORMALIZE_SPACE.getIRI()), arguments);
                  }
                }
                //	   	   	    	        	else if(entity.getName().equalsIgnoreCase("stringConcat"))
                // {
                //	   	   	    	        	OWLLiteral LitVar1 = factory.getOWLLiteral("ine");
                //	   	   	    	        	SWRLLiteralArgument LitVarArg1 =
                // factory.getSWRLLiteralArgument(LitVar1);
                //	   	   	    	        	arguments.add(LitVarArg1);
                //	   	   	    	        	bodyElement =
                // factory.getSWRLBuiltInAtom((SWRLBuiltInsVocabulary.STRING_CONCAT.getIRI()) ,
                // arguments);
                //	   	   	    	        	}
                System.out.println(bodyElement);
                bodyList.add(bodyElement);
                ...
                for (int i = 0; i < literal.length; i++) {
                  ...
                  if (entity.getName().equalsIgnoreCase("stringConcat")) {
                    bodyElement =
                        factory.getSWRLBuiltInAtom(
                            (SWRLBuiltInsVocabulary.STRING_CONCAT.getIRI()), arguments);
                  } else if (entity.getName().equalsIgnoreCase("substring")) {

                    bodyElement =
                        factory.getSWRLBuiltInAtom(
                            (SWRLBuiltInsVocabulary.SUBSTRING.getIRI()), arguments);

                  } else if (entity.getName().equalsIgnoreCase("tokenize")) {
                    bodyElement =
                        factory.getSWRLBuiltInAtom(
                            (SWRLBuiltInsVocabulary.TOKENIZE.getIRI()), arguments);
                  } else if (entity.getName().equalsIgnoreCase("substringBefore")) {
                    bodyElement =
                        factory.getSWRLBuiltInAtom(
                            (SWRLBuiltInsVocabulary.SUBSTRING_BEFORE.getIRI()), arguments);
                  } else if (entity.getName().equalsIgnoreCase("substringAfter")) {
                    bodyElement =
                        factory.getSWRLBuiltInAtom(
                            (SWRLBuiltInsVocabulary.SUBSTRING_AFTER.getIRI()), arguments);
                  }
                }
                System.out.println(bodyElement);
                bodyList.add(bodyElement);
                ...
                for (int i = 0; i < literal.length; i++) {
                  ...
                  if (entity.getName().equalsIgnoreCase("stringConcat")) {
                    ...
                    bodyElement =
                        factory.getSWRLBuiltInAtom(
                            (SWRLBuiltInsVocabulary.REPLACE.getIRI()), arguments);
                  } else if (entity.getName().equalsIgnoreCase("translate")) {
                    bodyElement =
                        factory.getSWRLBuiltInAtom(
                            (SWRLBuiltInsVocabulary.TRANSLATE.getIRI()), arguments);
                  }
                }
                System.out.println(bodyElement);
                bodyList.add(bodyElement);
          ...
          for (SWRLVariables entity : swrlVariable1.getEntities()) {
            ...
            if (variables.length != 2) {
              throw new IllegalArgumentException(
                  "The variable list must contain an even number of elements");
            }
            for (int v = 0; v < variables.length; v += 2) {
              String variable1 = variables[v];
              String variable2 = variables[v + 1];
              ...
              SWRLVariable swrlVar2 =
                  factory.getSWRLVariable(
                      IRI.create(
                          ontology.getOntologyID().getOntologyIRI().get() + "#" + variable2));
              SWRLObjectPropertyAtom headElement =
                  factory.getSWRLObjectPropertyAtom(ObjectPropertyX, swrlVar1, swrlVar2);
              headList.add(headElement);
            }
          }
        ...
        for (OWLNamedIndividual individual : ontology.getIndividualsInSignature()) {
          ...
          for (OWLNamedIndividual value : objectPropertyValues.getFlattened()) {
            ...
            propertyValues
                ...
                .add(objectproperty.getIRI().toString());
            propertyValues
                .computeIfAbsent(key, k -> new HashSet<>())
                .add(value.getIRI().toString());
          }
        }
      }
      Map<String, Set<String>> instances = new HashMap<>();
