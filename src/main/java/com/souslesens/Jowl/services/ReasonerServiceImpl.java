...
public class ReasonerServiceImpl implements ReasonerService{
	 ...
	 @Override
	 public String postConsistency(String filePath, String Url,String ontologyContentDecoded64) throws OWLOntologyCreationException, JsonProcessingException,Exception {
	     OWLOntologyManager manager = OWLManager.createOWLOntologyManager();
	     OWLOntology ontology = null ;
	     if ( ontologyContentDecoded64.isEmpty() == false) {
	    	 System.out.println("From HERe \n"+ontologyContentDecoded64);
