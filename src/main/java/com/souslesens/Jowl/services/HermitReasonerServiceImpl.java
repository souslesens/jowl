...
public class HermitReasonerServiceImpl implements HermitReasonerService {
    ...
    public static java.util.Map<String, Object> ReasonerOntologyCache = new java.util.HashMap<String, Object>();
    @Autowired
    ...
    public String getInferences(String filePath, String Url, List<String> ListOfValues, String graphName) throws Exception {
        ...
        System.out.println("-------ListOfValues-----------" + ListOfValues.toString());
        OWLOntologyManager manager = OWLManager.createOWLOntologyManager();
        OWLOntology ontology = null;
        ...
        Configuration config = new Configuration();
        Reasoner hermit = new Reasoner(config, ontology);
        System.out.println("configuring reasoner :" + (System.currentTimeMillis() - startTime));
...
//https://github.com/phillord/hermit-reasoner/blob/master/examples/org/semanticweb/HermiT/examples/MaterialiseInferences.java
        ...
        System.out.println("precomputeInferences  :" + (System.currentTimeMillis() - startTime));
        ...
        System.out.println("generators added  :" + (System.currentTimeMillis() - startTime));


        OWLOntology inferredOntology = (OWLOntology) ReasonerOntologyCache.get(graphName);
        if (inferredOntology == null) {
            inferredOntology = manager.createOntology();
            System.out.println("createOntology :" + (System.currentTimeMillis() - startTime));
        ...
        System.out.println("endAxioms  :" + (System.currentTimeMillis() - startTime));
        Set<OWLAxiom> inferredAxioms = new HashSet<>(inferredOntology.getAxioms());
        System.out.println("getAxioms  :" + (System.currentTimeMillis() - startTime));
        System.out.println(inferredAxioms.size());

        inferredAxioms.removeAll(originalAxioms);
        System.out.println("removeAll  :" + (System.currentTimeMillis() - startTime));
        System.out.println(inferredAxioms.size());
