...
| _POST_ | /reasoner/inference | Generating Inferences : can work with any input  (File , URL , Text, graphName) |
----------------
...
### Example 3 Of Use For Reasoning Part
...
| _POST_ | /axioms/listClassesWithAxioms | List classes with their labels and the relations of the axiom they have |
----------------
